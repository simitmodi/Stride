      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <AnimateIn delay={400} className="hidden lg:flex justify-center">
          <div className="w-full max-w-md aspect-square relative flex items-center justify-center">
            ...
            <div className="relative z-10 w-3/4 h-3/4 bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 flex items-center justify-center p-8 overflow-hidden">
               {/* inner fake UI */}
               <div className="w-full h-full flex flex-col gap-4 opacity-50">
                  ...
                  <div className="w-5/6 h-8 bg-slate-100 dark:bg-slate-800 rounded-md"></div>
