...
export const developersData: Record<string, DeveloperData> = {
    simit: {
        ...
        bio: "I am a motivated Computer Engineering student at SAL Institute of Technology and Engineering Research (GTU), with a deep passion for technology and innovation. With skills in programming languages such as C, Java, CSS, HTML5, Python for Data Science and SQL, I am eager to apply my technical knowledge to real-world challenges. Currently, I am working on two key projects: Data-Driven Fertilizer Optimization System (Smart India Hackathon 2024 entry) aimed at optimizing fertilizer usage in agriculture, improving sustainability, and increasing farmer income. Stride focused on improving user experience and minimizing repeat visits to banks through optimized appointment scheduling. In addition to my academic pursuits, I am an active volunteer as a PR Head at the Indian Society of Technical Education (ISTE), where I help organize and promote events for the student community. I am committed to continuous learning and growth, with plans to enhance my skills in Data Structures & Algorithms, Kotlin, and iOS development.",
