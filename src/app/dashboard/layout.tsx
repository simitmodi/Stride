...
export default function DashboardLayout({
  ...
  const isDeveloperRoute = pathname?.startsWith('/dashboard/developer');
  ...
  return (
    <div className="dashboard-theme flex min-h-screen w-full flex-col">
      <NotificationManager />
      <Header />
      <main className={`flex flex-1 flex-col p-4 md:p-8 pt-6 transition-[padding] duration-300 ${isChatOpen && !isDeveloperRoute ? "xl:pr-[430px]" : ""}`}>
        {children}
      </main>
