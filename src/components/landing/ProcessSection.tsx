      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <AnimateIn delay={400} className="hidden lg:flex justify-center">
          <div className="w-full max-w-md aspect-square relative flex items-center justify-center">
            ...
            <div className="relative z-10 w-3/4 h-3/4 bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex items-center justify-center p-8 overflow-hidden hover:-translate-y-2 transition-transform duration-500">
               {/* inner fake UI */}
