    ...
    <section className="w-full py-24 bg-[#F4F4F8] dark:bg-black">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feat, i) => (
            <AnimateIn key={i} delay={feat.delay} className="relative h-full flex">
              ...
              <div className="relative w-full h-full bg-white dark:bg-black rounded-xl p-[20px] shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden z-10">
                <div className="absolute inset-0 bg-primary/5 opacity-0 pointer-events-none"></div>

                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center mb-5 relative z-10">
                  {feat.icon}
                </div>
