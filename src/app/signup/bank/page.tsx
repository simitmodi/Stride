...
import { BankSignUpForm } from "@/components/auth/bank-signup-form";
import {
  Card,
  CardContent,
  CardDescription,
        ...
        <div className="group relative w-full">
          ...
          >
            <CardHeader className="text-center">
              <CardTitle className="text-2xl text-foreground">Bank Employee Registration</CardTitle>
            ...
            <CardContent>
              ...
              <p className="mt-6 text-center text-sm text-foreground/80">
                ...
                <Link href="/login/bank" className="font-medium text-primary underline-offset-4 hover:text-accent hover:underline transition-colors">
                  Log in
                </Link>
              </p>
            </CardContent>
